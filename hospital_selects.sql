...
FROM EXAMINATIONS
	...
	JOIN DOCTORS_EXAMINATIONS ON DOCTORS_EXAMINATIONS.EXAMINATION_ID = EXAMINATIONS.ID
WHERE EXTRACT(MONTH FROM CURRENT_DATE) - EXTRACT(MONTH FROM DOCTORS_EXAMINATIONS.EXAMINATION_DATE) < 6 
